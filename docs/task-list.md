...
- Last Completed: 2026-01-28 — Added integration tests for UID poll invite flows and ran `npm run test:integration`.
- Next Step: Add remaining E2E coverage (friends/groups + settings/profile, and Google login flow).
