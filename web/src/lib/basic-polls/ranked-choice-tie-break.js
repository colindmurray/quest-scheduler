export const RANKED_TIE_BREAK_METHODS = Object.freeze({
  BORDA: "BORDA",
  RANDOM: "RANDOM",
});

export function normalizeTieBreakMethod(value) {
...
export function listRankedTieBreakerRounds(finalResults = {}) {
...
export function resolveRankedFinalRound(finalResults = {}) {
...
export function resolveRankedPriorTieBreakerRounds(finalResults = {}) {
  const tieBreakerRounds = listRankedTieBreakerRounds(finalResults);
...
export function applyRankedChoiceTieBreaker({
  finalResults = {},
  optionIds = [],
  votes = [],
  method,
